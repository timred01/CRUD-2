...
<body>
    ...
    <!-- Footer -->
    <footer class="bg-dark text-white text-center" style="padding:5px;bottom: 0;position: fixed;width: 100%;height: 50px;line-height: 40px">
        <p>ReCreated With <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a style="color: #fff;">Alif F Hakim</a></p>
    </footer>
    <!-- Close Footer -->
